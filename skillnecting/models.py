...
class User(db.Model, UserMixin):
    ...
    user_designation = db.Column(db.String(50), nullable=False, default='engineer')
    short_description = db.Column(db.Text, nullable=False, default='I love writing codes and building stuff')
